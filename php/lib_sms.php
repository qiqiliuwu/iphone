...
function sendsms_imtong($mobile, $content)
{
	...
	//$sendurl = "http://".$smsapi."/".$charset."/interface/send_sms.aspx?username=".$GLOBALS['_CFG']['ihuyi_sms_user_name']."&password=".$GLOBALS['_CFG']['ihuyi_sms_pass_word']."&receiver=".$mobile."&content=".urlencode($content)."";
	
	$sendurl ="http://api.smsbao.com/sms?u=".$GLOBALS['_CFG']['ecsdxt_user_name']."&p=".md5($GLOBALS['_CFG']['ecsdxt_pass_word'])."&m=".$mobile."&c=".urlencode($content)."";
